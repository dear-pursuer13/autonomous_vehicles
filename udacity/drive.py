...
# from network_model1 import ResidualBlock, ResNet
...
model = ResNet(ResidualBlock, [3, 4, 6, 3], 1).to(device)"""
model = None
...
def telemetry(sid, data):
    if data:
        ...
        try:
            ...
            print('sterring_angle: {} throttle: {} speed: {}'.format(steering_angle, throttle, speed))
